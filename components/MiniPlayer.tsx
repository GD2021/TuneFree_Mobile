...
const MiniPlayer: React.FC<MiniPlayerProps> = ({ onExpand, layoutId }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`relative w-10 h-10 rounded-full overflow-hidden mr-3 flex-shrink-0 shadow-sm flex items-center justify-center ${hasSong ? "bg-gray-200" : "bg-gray-100"}`}
        >
